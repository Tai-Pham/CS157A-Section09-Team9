...
<html>
    ...
    <body>
        ...
        <h2> <span style='color:white; font-size:100px'>Client Registration</span></h2>
        
        <c:if test="${not empty error}">
    		<h2> ${error} </h2>
		</c:if>
        
        <form  action = "ClientRegServlet" method='post'>
            ...
            <input type ='number' name = 'age' required="required" min = '1' max = '105' style="height:50px; width:300px; font-size:25px;margin-bottom: 15px;">
