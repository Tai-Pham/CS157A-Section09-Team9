...
<html>
    ...
    <body style="background-color:gray;">
        <form  method='post'>
            ...
            <input type = 'text' name = 'testingLocation' style="height:50px; width:300px; font-size:25px;margin-bottom:15px;">
            <pre>
            ...
            else
            {
                ...
                try {
                    ...
                    else
                    {
                        ...
                        stmt = con.createStatement();
                        i = stmt.executeUpdate("INSERT INTO 157a_project.`tester`(`Account ID`, `Tester Name`) values('"+accountID+"', '"+testerName+"')");
